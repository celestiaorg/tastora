...
func NewLocalKeyringFromDockerContainer(ctx context.Context, dc client.CommonAPIClient, localDirectory, containerKeyringDir, containerID string) (keyring.Keyring, error) {
